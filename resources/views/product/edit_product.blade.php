                ...
                <div class="row justify-content-around">
                  <div class="col-lg-7">
                      <form action="{{route('product.update', $product->id)}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="editor" cols="30" rows="10" name="description" placeholder="Enter Description"> {{ old('description', $product->description) }}</textarea>
                            @error('description')
                              <div class="text-danger">{{$message}}</div>
                            @enderror
                          </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <form class="form-horizontal" action="" method="post" id="logo_upload_form" enctype="multipart/form-data">
                      <img src="{{ url('products/'.$product->image) }}" class="p-3" id="preview_image" width="100%" height="auto">
  ...
  <script>
     ...
     $(document).ready(function() {
            ...
            $('#logo_upload_form').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('product.imageupdate') }}", // Replace 'upload.php' with the URL to your server-side script
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
